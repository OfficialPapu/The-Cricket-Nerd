  ...
  return (
    <div className="bg-muted py-6 md:py-12">
      <div className="pb-6 md:pb-10">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-foreground justify-start text-[#2e3192]">Current Events</h2>
      </div>
                  ...
                  <Link href={`Spotlight/${NewsData[0]['Slug Url']}`}> <h1 className="text-3xl font-bold md:text-4xl">{TruncateText(NewsData[0].Title, 100)}
                   ...
                   <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: TruncateText(NewsData[0].Description, 200),
                      }}
                    ></p>
