...
const LoginMetaInfo = () => {
  useEffect(() => {
    const meta = {
      title: 'Login | The Cricket Nerd | Access Your Cricket Community Account',
      description:
        'Log in to The Cricket Nerd to access your account, stay updated with the latest cricket news, match analysis, and exclusive content.',
      keywords:
        'Cricket login, Cricket nerd login, Cricket community account, Login for cricket news, The Cricket Nerd account access, Nepal cricket login',
      canonical: 'https://www.thecricnerd.com/auth/login',
      openGraph: {
        title: 'Login | The Cricket Nerd | Access Your Cricket Community Account',
        description:
          'Log in to The Cricket Nerd to access your account, stay updated with the latest cricket news, match analysis, and exclusive content.',
        ...
        url: 'https://www.thecricnerd.com/auth/login',
        locale: 'en_US',
      },
